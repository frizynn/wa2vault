...
(DM) chats showing only a phone number (e.g. ``5491158057007@s.whatsapp.net``)
...
def normalize_jid(raw: str) -> str:
    ...
    Accepts a phone number in any human format ("+54 9 11 5805-7007",
    "5491158057007", "549 11 5805 7007") or a full JID
